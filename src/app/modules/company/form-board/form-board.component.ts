...
export class FormBoardComponent implements OnInit, OnDestroy {
  ...
  initializeValues() {
    this.activeForm = Constants.COMPANY_ENUM.COMPANY;
  }
  ...
  loadForm() {
    const { componentRef } = FormSequenceHandler.seriesFormLoad(this.componentFactoryResolver, Constants.FORM_TYPES.COMPANY, this.activeForm, this.modalBody)
