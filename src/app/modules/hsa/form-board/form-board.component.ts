...
export class FormBoardComponent implements OnInit, OnDestroy {
  ...
  initializeValues() {
    this.activeForm = Constants.HSA_ENUM.HSA;
  }
  ...
  loadForm() {
    const { componentRef } = FormSequenceHandler.seriesFormLoad(this.componentFactoryResolver, Constants.FORM_TYPES.HSA, this.activeForm, this.modalBody)
